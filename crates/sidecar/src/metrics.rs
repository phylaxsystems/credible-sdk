...
pub struct CacheMetrics {
    ...
    pub reset_required_head_counter: AtomicU64,
}
...
impl CacheMetrics {
    pub fn new() -> Self {
        Self {
            ...
            reset_required_head_counter: AtomicU64::new(0),
        }
    }
    ...
    /// (`sidecar_cache_reset_required_head_counter`)
    ///
    /// Commited as a `Counter`.
    pub fn increase_reset_required_head_counter(&self) {
        let reset_required_head_counter =
            self.reset_required_head_counter.load(Ordering::Relaxed) + 1;
        self.reset_required_head_counter
            .store(reset_required_head_counter, Ordering::Relaxed);
        counter!("sidecar_cache_reset_required_head_counter").increment(1);
    }
