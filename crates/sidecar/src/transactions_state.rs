...
pub struct TransactionsState {
    pub transaction_results: DashMap<B256, TransactionResult>,
    ...
    pub transaction_results_pending_requests: DashMap<TxHash, oneshot::Sender<TransactionResult>>,
    /// `HashSet` containing the accepted transactions which haven't been processed yet.
    pub accepted_txs: DashSet<TxHash>,
}
